...
function Header({ props }: Header): JSX.Element {
    ...
    return (
        <header>
            <nav className="bg-this.bgColor border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="#" className="flex items-center"> <FaCubes className="text-[2rem]" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap mx-6">Flowbite</span>
                    </a>
