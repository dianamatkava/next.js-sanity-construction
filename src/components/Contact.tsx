...
function Contact () {
  return (
    <div className="self-stretch flex-col justify-start items-center gap-12 flex w-full h-full" id='Contact'>
      <div className="self-stretch flex-col justify-start items-start flex h-full">
        ...
        <div className="w-full flex justify-center items-center h-full sm:gap-12 custom-lg:justify-between">
        <ContactInfo className="hidden md:flex"/>
        <div className="self-stretch flex flex-col justify-center items-center gap-4">
          <div className="self-stretch sm:w-[400px] h-full flex flex-col gap-4">
            <div className="self-stretch text-[#424242] text-lg font-semibold font-playfair leading-0 mb-3">Leave a request
