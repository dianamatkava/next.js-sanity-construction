...
const ServiceItem = ({serviceId}) => {
  return (
      <div
        className="sm:max-w-72 max-w-72 border-r border-b border-[#e2e2e2] flex-col justify-center items-start pb-3 gap-2 inline-flex hover:shadow-lg">
        ...
        <div className="self-stretch flex-col justify-start items-start gap-4 flex px-4">
          ...
          <ReadMoreLink href={`/services/${serviceId}`} name={"Read More"}/>
        </div>
      </div>
  )
}
